...
// parsePypiName 解析 Python 包名称（.egg-info 或 .dist-info）
...
// parseJarFilename 解析 JAR 文件名，提取名称和版本
...
// findJar 扫描 JAR 文件，提取其中的 JAR 包信息
func findJar(c *businessplugins.Client, rec *businessplugins.Record, r *zip.Reader, n string) {
...
func (h *SoftwareHandler) Handle(c *businessplugins.Client, cache *engine.Cache, seq string) {
	// 扫描 dpkg 包（Debian/Ubuntu）
	...
	dirs.Each(func(path string) bool {
