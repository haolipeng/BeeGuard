...
|------|---------|---------|---------|---------|
| collector | port_test.go | [自动化](standalone-test/collector-testing.md) | - | [数据库验证](integration-test/local-integration-testing.md#四collector-插件测试) |
| baseline | - | [E2E 测试](standalone-test/baseline-testing.md) | - | [数据库验证](integration-test/local-integration-testing.md#七baseline-插件测试) |
| detector | - | - | 需手动验证 | [数据库验证](integration-test/local-integration-testing.md#六detector-插件测试) |
| ebpf_base_detector | - | - | 需手动验证 | [数据库验证](integration-test/local-integration-testing.md#五ebpf_base_detector-插件测试--告警检测) |
| scanner | - | [E2E 测试](standalone-test/scanner-testing.md) | - | [数据库验证](integration-test/local-integration-testing.md#八scanner-插件测试) |
| nids | - | [手动验证](standalone-test/nids-testing.md) | - | [数据库验证](integration-test/local-integration-testing.md#九nids-插件测试) |
