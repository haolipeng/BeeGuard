...
| 配置文件 | 路径 | 用途 |
|---------|------|------|
| 高危命令规则 | `/opt/cloudsec/plugins/ebpf_base_detector/config/dangerous_commands.yaml` | 定义 4 条高危命令检测规则 |
...
**规则配置文件:**
`/opt/cloudsec/plugins/ebpf_base_detector/config/dangerous_commands.yaml`
